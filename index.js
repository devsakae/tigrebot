...
const { apiFootball, footApi } = require('./src/bolao');
...
client.on('message', async (m) => {
  ...
  // Módulo Bolão
  // await apiFootball(m); // (API-FOOTBALL - https://rapidapi.com/api-sports/api/api-football/)
  await footApi(m); // (FootApi - https://rapidapi.com/fluis.lacasse/api/footapi7)
});
